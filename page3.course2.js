...
var content = document.querySelector('.cours');
...
document.getElementById("price").addEventListener("click",function(){
    ...
    for(var i=0;i<cours.length;i++){
        ...
        if(document.getElementById("price").value>=cours[i].price){
            document.getElementsByClassName("cours")[i].style.display="block";
        }
        else{
            document.getElementsByClassName("cours")[i].style.display="none";
...
function CheckBySearch(){
    for(var i=0;i<cours.length;i++){
        ...
        if(cours[i].title.toUpperCase().indexOf(input)>-1){
            document.getElementsByClassName("cours")[i].style.display="block";
        }
        else{
            document.getElementsByClassName("cours")[i].style.display="none";
